#!/usr/bin/env python3
"""Decisive long-run judgement of candidates G, H, I -- the remaining screen hits (2,4) candidate.
...
SPECS=[("x2 (control)","1RB0RE_1RC---_0LD1LE_0RE1LD_1RF0LC_0RA1RE"),
       ("cand-G","1RB0LA_1RC0RE_0RD---_1LA0LD_1LD1RF_1RA1LB"),
       ("cand-H","1RB0RE_0RC0RA_1LD1RE_1LA0LD_1RA0LF_1LD---"),
       ("cand-I","1RB0LA_1RC0RE_0RD---_1LA1LF_1LD1RF_1RA1LB")]
