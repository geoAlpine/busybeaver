#!/usr/bin/env python3
"""Decisive long-run judgement of candidates E and F -- further independent (2,4) candidate.
...
SPECS=[("x2 (control)","1RB0RE_1RC---_0LD1LE_0RE1LD_1RF0LC_0RA1RE"),
       ("cand-E","1RB0RE_0RC0RA_1LD0RF_1LA0LD_1RA0LC_1RC---"),
       ("cand-F","1RB0LE_1RC0RF_0RD0RB_1RE0RC_1LA0LA_1RA---")]
