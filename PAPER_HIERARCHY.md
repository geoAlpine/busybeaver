...
rests on an external theorem (the base-`q` range of a non-linear natural polynomial is not context-free;
Pálvölgyi, arXiv:1901.03913, 2019) and is cited as input, **not** claimed self-contained. We give a second, orthogonal proven
...
> one (`CF ⊊ CS`) cites one external theorem (Pálvölgyi, arXiv:1901.03913), flagged as input.
...
theorem of D. Pálvölgyi, *The range of non-linear natural polynomials cannot be context-free* (arXiv:1901.03913,
2019): the base-`q`
...
- A. Dubickas, *On integer sequences generated by linear maps*, Glasgow Math. J. **51** (2009), no. 2,
  243–252 (Thm 3: subword-complexity lower bound, slope `\log q/\log(p/q)`). — §5, Lemma 6.
...
- D. Pálvölgyi, *The range of non-linear natural polynomials cannot be context-free*, arXiv:**1901.03913**
  (2019). — base-`q` range of a polynomial is CF iff linear (§3.6 lower half; the only non-self-contained rung).
...
- T. Tao, *Almost all orbits of the Collatz map attain almost bounded values*, arXiv:**1909.03562**
  (2019/2022); L. Flatto, J. C. Lagarias, A. D. Pollington, *On the range of fractional parts {ξ(p/q)ⁿ}*,
  Acta Arith. **70** (1995), no. 2, 125–147; M. Andrieu, S. Eliahou, L. Vivion, *A Normality Conjecture on
  Rational Base Number Systems*, arXiv:**2510.11723** (2025). — the Mahler/AEV single-orbit equidistribution
  frontier (§5 ceiling, §7 [OPEN]).
